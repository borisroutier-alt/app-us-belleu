  ...
  const handleAuth = async () => {
    ...
    if (isRegisterMode) {
      try {
        ...
        console.log("Résultat de la recherche liste blanche :", estAutorise);

        if (!estAutorise || !estAutorise.email) {
          console.log("❌ ACCÈS REFUSÉ : Cet email n'est pas dans la liste blanche !");
        ...
        console.log("✅ ACCÈS AUTORISÉ ! Création du compte en cours...");
